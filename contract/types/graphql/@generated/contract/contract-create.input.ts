...
import { PlanCreateNestedOneWithoutContractsInput } from '../plan/plan-create-nested-one-without-contracts.input';
...
export class ContractCreateInput {
    ...
    @Field(() => PlanCreateNestedOneWithoutContractsInput, {nullable:false})
    plan!: PlanCreateNestedOneWithoutContractsInput;
}
