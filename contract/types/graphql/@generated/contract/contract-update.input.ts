...
import { PlanUpdateOneRequiredWithoutContractsNestedInput } from '../plan/plan-update-one-required-without-contracts-nested.input';
...
export class ContractUpdateInput {
    ...
    @Field(() => PlanUpdateOneRequiredWithoutContractsNestedInput, {nullable:true})
