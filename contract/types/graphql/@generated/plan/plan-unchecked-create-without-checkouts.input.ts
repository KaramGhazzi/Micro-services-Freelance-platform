...
import { ContractUncheckedCreateNestedManyWithoutPlanInput } from '../contract/contract-unchecked-create-nested-many-without-plan.input';

@InputType()
export class PlanUncheckedCreateWithoutCheckoutsInput {
    ...
    @Field(() => ContractUncheckedCreateNestedManyWithoutPlanInput, {nullable:true})
    contracts?: ContractUncheckedCreateNestedManyWithoutPlanInput;
}
