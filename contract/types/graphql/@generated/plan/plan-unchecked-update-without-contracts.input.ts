...
import { CheckoutUncheckedUpdateManyWithoutPlanNestedInput } from '../checkout/checkout-unchecked-update-many-without-plan-nested.input';

@InputType()
export class PlanUncheckedUpdateWithoutContractsInput {
    ...
    @Field(() => CheckoutUncheckedUpdateManyWithoutPlanNestedInput, {nullable:true})
    checkouts?: CheckoutUncheckedUpdateManyWithoutPlanNestedInput;
}
