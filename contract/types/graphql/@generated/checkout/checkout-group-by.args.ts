...
import { CheckoutOrderByWithAggregationInput } from './checkout-order-by-with-aggregation.input';
import { CheckoutScalarFieldEnum } from './checkout-scalar-field.enum';
import { CheckoutScalarWhereWithAggregatesInput } from './checkout-scalar-where-with-aggregates.input';
...
@ArgsType()
export class CheckoutGroupByArgs {

    @Field(() => CheckoutWhereInput, {nullable:true})
    @Type(() => CheckoutWhereInput)
    where?: CheckoutWhereInput;

    @Field(() => [CheckoutOrderByWithAggregationInput], {nullable:true})
    orderBy?: Array<CheckoutOrderByWithAggregationInput>;

    @Field(() => [CheckoutScalarFieldEnum], {nullable:false})
    by!: Array<keyof typeof CheckoutScalarFieldEnum>;
