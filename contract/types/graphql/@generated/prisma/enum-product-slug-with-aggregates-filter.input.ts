...
import { NestedEnumProductSlugWithAggregatesFilter } from './nested-enum-product-slug-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumProductSlugFilter } from './nested-enum-product-slug-filter.input';

@InputType()
export class EnumProductSlugWithAggregatesFilter {
