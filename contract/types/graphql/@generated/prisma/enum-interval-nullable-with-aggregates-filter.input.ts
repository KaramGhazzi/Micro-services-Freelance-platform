...
import { NestedEnumIntervalNullableWithAggregatesFilter } from './nested-enum-interval-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumIntervalNullableFilter } from './nested-enum-interval-nullable-filter.input';

@InputType()
export class EnumIntervalNullableWithAggregatesFilter {
