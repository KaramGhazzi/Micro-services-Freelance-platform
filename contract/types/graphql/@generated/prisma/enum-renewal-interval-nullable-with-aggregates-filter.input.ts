...
import { NestedEnumRenewalIntervalNullableWithAggregatesFilter } from './nested-enum-renewal-interval-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumRenewalIntervalNullableFilter } from './nested-enum-renewal-interval-nullable-filter.input';

@InputType()
export class EnumRenewalIntervalNullableWithAggregatesFilter {
