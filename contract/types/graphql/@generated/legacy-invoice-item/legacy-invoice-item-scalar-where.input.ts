...
@InputType()
export class LegacyInvoiceItemScalarWhereInput {

    @Field(() => [LegacyInvoiceItemScalarWhereInput], {nullable:true})
    AND?: Array<LegacyInvoiceItemScalarWhereInput>;

    @Field(() => [LegacyInvoiceItemScalarWhereInput], {nullable:true})
    OR?: Array<LegacyInvoiceItemScalarWhereInput>;

    @Field(() => [LegacyInvoiceItemScalarWhereInput], {nullable:true})
    NOT?: Array<LegacyInvoiceItemScalarWhereInput>;
