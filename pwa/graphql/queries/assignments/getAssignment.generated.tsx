...
export type GetAssignmentQueryVariables = Types.Exact<{
...
export const GetAssignmentDocument = gql`
  query getAssignment($where: AssignmentWhereInput!) {
...
export function useGetAssignmentQuery(
  ...
  > &
    (
      | { variables: GetAssignmentQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
...
>;
export type GetAssignmentSuspenseQueryHookResult = ReturnType<
  typeof useGetAssignmentSuspenseQuery
>;
